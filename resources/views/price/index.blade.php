                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="{{ url('/' . $item->id . '/edit') }}" title="Editar">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('lista.store') }}" onsubmit="return checkSubmit();">
                    ...
                    <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                        <input id="name" placeholder="name" type="text" class="text-dark form-control @error('name') is-invalid @enderror" name="name" value="{{ Auth::user()->name }}" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    {{-- price --}}
                    <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                        <input id="price" placeholder="price" type="number" class="text-dark form-control @error('price') is-invalid @enderror" name="price" value="{{ Auth::user()->price }}" required autocomplete="price" autofocus>
            ...
            <div class="modal-footer">
                <button style="border-radius: 20%" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times-circle"></i> Cerrar
                </button>
            </div>
        </div>
    </div>
