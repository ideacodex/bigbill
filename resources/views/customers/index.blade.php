            ...
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_length" id="bootstrap-data-table_length">
                                    <label>Mostrar <select name="bootstrap-data-table_length"
                ...
                <div class="row table-responsive">
                    <div class="col-sm-12">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered dataTable no-footer"
                            ...
                            <thead>
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1"
                                        colspan="1" style="width: 322px;" aria-sort="ascending"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1"
                                        colspan="1" style="width: 509px;"
                                        aria-label="Position: activate to sort column ascending">Apellido</th>
                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1"
                                        ...
                                        aria-label="Salary: activate to sort column ascending">Nit</th>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ url('clientes/' . $item->id . '/edit') }}" title="Editar">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5">
                        <div class="dataTables_info" id="bootstrap-data-table_info" role="status" aria-live="polite">Tabla
                            de
                            elementos
                        </div>
                    </div>
