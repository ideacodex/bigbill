...
<<<<<<< HEAD
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <a href="{{ route('clientes.create') }}" style="border-radius: 95px;" class="btn btn-success btn-sm mt-2 ml-3">&nbsp;
                            Agregar Cliente
                            <i class="fas fa-plus-square"></i>
                        </a>
                        <a class="btn btn-danger btn-sm mt-2" style="border-radius: 95px;" type="submit" href="{{ route('Customer.pdf') }}">Reporte pdf <i class="fas fa-file-alt"></i>
                        </a>
                    </div>
                    <!-- boton agregar -->
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="{{ url('clientes/' . $item->id . '/edit') }}" title="Editar">
                                                    ...
                                                    <form id="formDel{{ $item->id }}" action="{{ url('clientes/' . $item->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
                            ...
                            <div class="row table-responsive">
                                <div class="col-12">
                                    ...
                                    @else
                                        ...
                                        @endif
                                    @endif
>>>>>>> 057fae86a073217a5d0073ba454b06aeb8b71b82
                                </div>
                            </div>
                        </div>
                    </div>
