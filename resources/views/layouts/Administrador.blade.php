        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background: black">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ url('Personal') }}"> <i
                                class="text-light menu-icon fas fa-toolbox"></i>Administrador:
                            {{ Auth::user()->name }}</a>
                    </li>

                    <h3 class="menu-title text-light">Gestiones</h3>{{-- <!-- /.menu-title --> --}}
                    <li class="menu-item text-light">
                        ...
                        <a href="{{ url('suscripcion') }}">
                            <i class="text-light menu-icon fas fa-tasks"></i>Gestionar suscripciones
                        </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu" style="background: black">
                            <li><i class="text-primary fas fa-check"></i><a href="{{ route('TipodeCuenta.index') }}">
                                    Tipos</a></li>
                            <li><i class="text-primary fas fa-check"></i><a href="{{ route('cuentas.index') }}">
                                    Cuentas</a>
                            </li>
                        </ul>
                    </li>
                   ...
                   {{--  <li class="menu-item-has-children dropdown">
                    ...
                    <h3 class="menu-title text-light">Extras</h3>{{-- <!-- /.menu-title --> --}}
                    <li class="menu-item">
                        <a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i
                                class="text-light menu-icon fas fa-power-off"></i> Cerrar sesión</a>
                    </li>
