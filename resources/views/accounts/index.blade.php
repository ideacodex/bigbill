            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <button type="button" style="border-radius: 95px;" class="btn btn-success mb-1 ml-2 mt-2" data-toggle="modal" data-target="#largeModal">
                            Agregar Cuenta
                            <i class="fas fa-plus-square"></i>
                        </button>
                        <a class="btn btn-danger btn-sm mt-2" style="border-radius: 95px;" type="submit" href="{{ route('Account.pdf') }}">Reporte pdf <i class="fas fa-file-alt"></i>
                        </a>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('cuentas.store') }}" onsubmit="return checkSubmit();">
                    ...
                    <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                        ...
                        <input id="name" type="text" class="text-dark form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Nombre de la cuenta" required autocomplete="name" autofocus>
