                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                            ...
                            sucesivamente podras loguearte en la opción de "INICIAR SESION".
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                ...
                                Olvidé mi contraseña ¿como la restablezco?
                            </button>
                        </h5>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="card-body">
                            Si olvidaste tu contraseña para iniciar secion y ver tu informacion, entonces debes de
                            enviar un correo espeficando tu ususario y el motivo del cambio de contraseña. El formulario
                    ...
                    <div class="card-header" id="headingThree">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                ...
                                Suscripción y forma de trabajo
                            </button>
                        </h5>
                    </div>
