                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('empresas/' . $companies->id) }}" method="POST" file="true" enctype="multipart/form-data" onsubmit="return checkSubmit();">
                            ...
                            {{-- imagen --}}
                            <div class="col-12 col-md-6 input-group input-group-lg mb-3 ">
                                <img src="{{ asset('/storage/companias/' . $companies->file) }}" width="150px" height="150px" alt="compania">
                    ...
                    <script>
                        ...
                        function updateClock() {
                            ...
                            if (totalTime == 0) {
                                ...
                                var texto = "Salga de esta pestaña de lo contrario tendra serios problemas con el administrador"
