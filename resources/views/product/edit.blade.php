                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div>
                                    <form name="calculadora" action="{{ url('productos/' . $products->id) }}"
                                        ...
                                        <form action="{{ url('productos/' . $products->id) }}" method="POST"
                                            ...
                                            <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                ...
                                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                    ...
                                                    <input class="form-control" type="number" id="grandTotal"
                                                        value="{{ $products->quantity_values }}" readonly
                                                ...
                                                <input id="date_values" name="date_values" type="datetime"
                                                    ...
                                                    required autocomplete="date_values" autofocus readonly="readonly">
                                                @error('date_values')
                                            ...
                                            <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                ...
                                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                    <input id="amount_expenses" name="amount_expenses" type="hidden"
                                                        ...
                                                        value="{{ $products->amount_expenses }}" placeholder="000"
                                                        required autocomplete="amount_expenses" autofocus
                                                        readonly="readonly">
                                                ...
                                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                    ...
                                                    <input class="form-control" type="number" id="total"
                                                        name="total_revenue" value="0" readonly />
                                                    @error('quantity_values')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                ...
                                                <input id="date_discharge" name="date_discharge" type="date_discharge"
                                                    ...
                                                    value="<?php echo date('y/m/d'); ?>"
                                                    required autocomplete="date_discharge" autofocus readonly="readonly ">
                                            ...
                                            <div class="container mt-4">
                                                ...
                                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                                    <input value="{{ $products->total_revenue }}" type="hidden"
                                                        id="txt_campo_1" class="monto" onchange="sumar();"
                                                        name="income_amount" readonly />
                                                </div>
