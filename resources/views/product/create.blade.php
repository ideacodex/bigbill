                                    ...
                                    <form action="{{ url('productos') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                            ...
                                            <input id="quantity_values" name="quantity_values" type="number"
                                                ...
                                                onchange="sumar();" value="" placeholder="Cantidad de ingreso" required
                                        ...
                                        <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text transparent" id="inputGroup-sizing-sm">
                                                    <i title="Stock" class="fas fa-cart-arrow-down"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text transparent" id="inputGroup-sizing-sm">
                                                    <i title="Precio especial" class="fas fa-box-open"></i>
                                                </span>
                                            </div>
                                            <input id="special_price" name="special_price" type="number"
                                                class="text-dark form-control special_price  @error('special_price') is-invalid @enderror"
                                                value="" placeholder="Precio especial" autocomplete="special_price"
                                                autofocus>
                                            @error('special_price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
