                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <form action="{{ url('productos') }}" method="POST" enctype="multipart/form-data" file="true">
                                @csrf
                                {{-- Nombre --}}
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="name" name="name" type="text" class="text-dark form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Producto" required autocomplete="name" autofocus>
                                    @error('name')
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="description" name="description" type="text" class="text-dark form-control @error('name') is-invalid @enderror" value="{{ old('description') }}" placeholder="Descripción del producto" required autocomplete="description" autofocus>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <select name="kind_product" id="kind_product" onchange="mostrarInput();" class="form-control @error('kind_product') is-invalid @enderror" required>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="a">
                                    ...
                                    <input id="cost" name="cost" type="number" class="text-dark form-control @error('cost') is-invalid @enderror" placeholder="Precio de compra" autocomplete="cost" autofocus>
                                    @error('cost')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="b">
                                    ...
                                    <input id="price" name="price" type="number" class="text-dark form-control @error('price') is-invalid @enderror" placeholder="Precio de venta" autocomplete="price" autofocus>
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="c">
                                    ...
                                    <input id="special_price" name="special_price" type="number" step="0.01" value="" min="0.01" class="text-dark form-control @error('special_price') is-invalid @enderror" placeholder="Precio Especial" autocomplete="special_price" autofocus>
                                    @error('special_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div id="d" class="d-none col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="credit_price" name="credit_price" type="number" step="0.01" value="" min="0.01" class="text-dark form-control @error('credit_price') is-invalid @enderror" placeholder="Precio Credito" autocomplete="credit_price" autofocus>
                                    @error('credit_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <select name="tax" id="tax" class="form-control @error('tax') is-invalid @enderror" required>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="quantity_values" name="quantity_values" type="number" class="text-dark form-control quantity_values  @error('quantity_values') is-invalid @enderror" onchange="sumar();" value="" placeholder="Cantidad a Ingresar" required autocomplete="quantity_values" autofocus>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <select name="dimensiones" id="dimensiones" onchange="MostrarDimensiones();" class="form-control" required>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="Peso">
                                    ...
                                    <input id="weight" name="weight" type="text" class="text-dark form-control @error('weight') is-invalid @enderror" placeholder="Peso lbs ó kgs" autocomplete="weight" autofocus>
                                    @error('weight')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="Altura">
                                    ...
                                    <input id="tall" name="tall" type="text" class="text-dark form-control @error('tall') is-invalid @enderror" placeholder="Altura" autocomplete="tall" autofocus>
                                    @error('tall')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="Ancho">
                                    ...
                                    <input id="broad" name="broad" type="text" class="text-dark form-control @error('broad') is-invalid @enderror" placeholder="Ancho" autocomplete="broad" autofocus>
                                    @error('broad')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                {{-- <!--Profundidad --> --}}
                                <div class="d-none col-12 col-md-6 input-group input-group-lg mb-3" id="Profundidad">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text transparent" id="inputGroup-sizing-sm">
                                            <i class="fas fa-ruler"></i>
                                        </span>
                                    </div>
                                    <input id="depth" name="depth" type="text" class="text-dark form-control @error('depth') is-invalid @enderror" placeholder="Profundidad" autocomplete="depth" autofocus>
                                    @error('depth')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <select class="js-example-basic-multiple js-states form-control @error('family_id') is-invalid @enderror" name="family_id[]" id="family_id" multiple="multiple" required>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <select class="js-example-basic-multiple js-states form-control @error('mark_id') is-invalid @enderror" name="mark_id[]" id="mark_id" multiple="multiple" required>
                                ...
                                <div class="container mt-4">
                                    <div class="col-12">
                                        <div class="col text-center">
                                            <button type="submit" style="border-radius: 10px" class="btn btn-lg btn-primary mt-3" name="enviar">
