                            ...
                            <form action="{{ url('productos') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="name" name="name" type="text"
                                        class="text-dark form-control @error('name') is-invalid @enderror" value="{{ old('name') }}"
                                        placeholder="Nombre del Producto: ej. computadora" required autocomplete="name" autofocus>
                                    @error('name')
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="price" name="price" type="text"
                                        ...
                                        value="{{ old('price') }}" placeholder="Precio del Producto: ej. computadora" required
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text transparent" id="inputGroup-sizing-sm">
                                            <i title="company_id" class="fas fa-building"></i>
                                        </span>
                                    </div>
                                    <input id="company_id" name="company_id" type="text"
                                        class="text-dark form-control @error('company_id') is-invalid @enderror"
                                        value="{{ old('company_id') }}" placeholder="Id de la Compañia: ej. 1 = pc tecnologi"
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="quantity_values" name="quantity_values" type="number"
                                        class="text-dark form-control @error('quantity_values') is-invalid @enderror" value="000"
                                        placeholder="000" required autocomplete="quantity_values" autofocus>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="income_amount" name="income_amount" type="number"
                                        class="text-dark form-control @error('income_amount') is-invalid @enderror" value="000"
                                        placeholder="000" required autocomplete="income_amount" autofocus>
                                    @error('income_amount')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 input-group input-group-lg mb-3">
                                    ...
                                    <input id="amount_expenses" name="amount_expenses" type="number"
                                        class="text-dark form-control @error('amount_expenses') is-invalid @enderror" value="000"
                                        placeholder="000" required autocomplete="amount_expenses" autofocus readonly="readonly">
